...
var mangenCmd = &cobra.Command{
	Use:   "mangen [dir]",
	Short: "generates a man (1) page for tom. in the given directory",
	Long: "generates a man (1) page for tom. in the given directory. defaults to current directory",
...
func writeManpages(root *cobra.Command, dir string) error {
	...
	header := &doc.GenManHeader{
		Title:   "tom",
		Section: "1",
		Source:  "generated by `tom mangen`",
		Date:    &date,
	}
